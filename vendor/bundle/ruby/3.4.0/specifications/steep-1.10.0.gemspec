...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<language_server-protocol>.freeze, [">= 3.17.0.4".freeze, "< 4.0".freeze])
  s.add_runtime_dependency(%q<rbs>.freeze, ["~> 3.9".freeze])
  s.add_runtime_dependency(%q<concurrent-ruby>.freeze, [">= 1.1.10".freeze])
  s.add_runtime_dependency(%q<terminal-table>.freeze, [">= 2".freeze, "< 5".freeze])
  ...
  s.add_runtime_dependency(%q<uri>.freeze, [">= 0.12.0".freeze])
  s.add_runtime_dependency(%q<mutex_m>.freeze, [">= 0.3.0".freeze])
end
